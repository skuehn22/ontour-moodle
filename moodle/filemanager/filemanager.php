...
//Application Title
define('APP_TITLE', 'onTour File Manager');
...
$auth_users = array(
    'admin' => '$2y$10$zCXdfKBDNrLOiUtXgTcrQ.OWrIO7LfZRhH.TE4EgKg5gACjFrKGXi', //admin@123
	'kai' => '$2y$10$d8bFa31tgMuSWNIvYQ/91.WtUuUVDa/mtg5df0UrTzXtH6.sEDEAy',
	'matthias' => '$2y$10$jysYQq4Qj91KBhOfLNWxQOoRcqjPYm/IIAMpSZsKE6qb8CufSYQFO'
);
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/filemanager";
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                          <p><img src="https://reisen.ontour.org/pix/theme/onTour.png"></p>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-success btn-block mt-4" role="button" style="background-color: #49AEDB!important; border-color: #49AEDB!important">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                                </form>
