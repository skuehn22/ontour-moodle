...
//use columns2.php to pass parameter to header_backend.mustache
if (isloggedin()) {
    $headerlayout = $OUTPUT->render_from_template('theme_klass/header_backend', ['templatecontext' => $templatecontext, 'display' => $display, 'test' => 'test']);
} else {
    $headerlayout = $OUTPUT->render_from_template('theme_klass/header', $templatecontext, $display);
}
