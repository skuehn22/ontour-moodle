...
class theme_klass_core_course_renderer extends core_course_renderer {
    ...
    public function frontpage_available_courses() {
        ...
        $header = '<div id="frontpage-course-list"><div class="courses frontpage-course-list-all"><div class="row">'; $footer = '</div></div></div>';
        $cocnt = 1;
        $content = '';
        if ($ccc = get_courses('all', 'c.sortorder ASC', 'c.id, c.shortname, c.visible')) {
            foreach ($courseids as $courseid) {
                ...
                $content .= '<div class="staticpage-wrapper container container-full p-0" >
    <div class="staticpage-content">
        <!-- menu under header image -->
        <div class="row p-1">
            <div class="col-md-12">
                        <div class="col-md-12 col-xs-12 pt-5">
                            <div class="row">
                                <div class="offset-md-1 col-md-10 col-xs-12">
                                    <h2 class="content-heading">Virtuelle Reisen</h2>
                                    <p class="content-subheading">Reine virtuelle Reisen werden nur virtuell in der Schule durchgeführt.</p>
                                </div>
                            </div>
                            <div class="row pb-5">
                                    ...
                                    <div class="row">
                                        <div class="col-6 text-center pb-3">
                                            <div class="card card-1">
                                                <div class="card-body text-left" style="padding: 0; border: 1px solid #ccc;  border-radius: 8px;">

                                                    <div class="row">

                                                        <div class="col-md-4">
                                                            <img src="/pix/theme/Interaktiv-individuell.jpg" style="height: 100%;">
                                                        </div>
                                                        <div class="col-md-8">

                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <h3 class="pt-3"><strong>Berlin</strong></h3>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 pl-0 pb-3 pt-1">
                                                                <a href="/course/view.php?id=5" class="btn btn-secondary btn-block trip-nav-button text-transform-none" style="width: 150px;">Zu der Reise</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card card-1">
                                                <div class="card-body text-left" style="padding: 0; border: 1px solid #ccc;  border-radius: 8px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="/pix/theme/emotional-persoenlich.jpg" style="height: 100%;">
                                                        </div>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="card card-1">
                                                <div class="card-body text-left" style="padding: 0; border: 1px solid #ccc;  border-radius: 8px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="/pix/theme/Unique-Projektergebnis.jpg" style="height: 100%;">
                                                        </div>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="card card-1">
                                                <div class="card-body text-left" style="padding: 0; border: 1px solid #ccc;  border-radius: 8px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <img src="/pix/theme/eine-unvergessliche-erinnerung.jpg" style="height: 100%;">
                                                        </div>
                                                        <div class="col-md-8">
                        ...
                        </div><div class="col-md-12 col-xs-12 background pt-5 pb-5">
                            <div class="row">
                                <div class="offset-md-1 col-md-10 col-xs-12  pt-5">
                                    <h2 class="content-heading">Hybride Reisen</h2>
                                    <p class="content-subheading">Hybride Reisen finden sowohl in der Schule, als auch im Zielort selbst statt.</p>
                                </div>
                            </div>
                            <div class="row pb-5">
                                <div class="offset-md-1 col-md-10 pb-5">
                        ...
                        </div><div class="col-md-12 col-xs-12 pt-5 pb-5">
                            <div class="row">
                                <div class="offset-md-1 col-md-10 col-xs-12  pt-5">
                                    <h2 class="content-heading">Reisempfelungen</h2>
                                    <p class="content-subheading">Unsere Empfelungen für Ihre nächste Reise.</p>
                                </div>
                            </div>
                            <div class="row pb-5">
                                <div class="offset-md-1 col-md-10 pb-5">
                                                ...
                                                <div class="card-body text-left" style="padding: 0; border: 1px solid #ccc;  border-radius: 8px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="col-md-12 pl-0 pb-3 pt-1">
                                                                <a href="#" class="btn btn-secondary btn-block trip-nav-button text-transform-none" style="width: 250px;">Weitere Informationen</a>
                                                            </div>
                                                        </div>
                                                    </div>
