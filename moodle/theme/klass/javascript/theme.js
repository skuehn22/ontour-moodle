...
$(document).ready(function() {
    ...
    $(window).scroll(function() {
        ...
        if (scroll >= 60) {
            ...
            $('.navbar-brand img').attr('src', '/pix/theme/projektreisen-grau.png');
            $('.phone-button img').attr('src', '/pix/theme/Telefon-Header.png');
        } else {
            $(".navbar").removeClass("bg-light");
            $('.navbar-brand img').attr('src', '/pix/theme/projektreise.png');
            $('.phone-button img').attr('src', '/pix/theme/Telefon-Header-weiß.png');
        }
        */
