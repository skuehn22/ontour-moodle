...
if($typ == "student"){
    ...
    if($typ=="direct"){
        ...
        $group_tmp = $DB->get_record_sql($sql);
        $obj->groupid = $group_tmp->groupid;
        echo $OUTPUT->render_from_template('finishing/direct_overview', $obj);

    }else{
        //echo $OUTPUT->render_from_template('finishing/deactivate', $obj);
        echo $OUTPUT->render_from_template('finishing/index', $obj);
    }
