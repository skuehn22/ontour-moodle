...
class backup_stickynotes_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $stickynotescolumns = new backup_nested_element('stickynotes_columns');
        $stickynotescolumn = new backup_nested_element('stickynotes_column', array('id'),
                                                            array('title',
                                                            'column_order'));

        $stickynotesnotes = new backup_nested_element('stickynotes_notes');
        $stickynotesnote = new backup_nested_element('stickynotes_note', array('id'),
                                                        array('userid',
                                                            'stickycolid',
                                                            'message',
                                                            'color',
                                                            'timecreated',
                                                            'timemodified'));
        $stickynotesvotes = new backup_nested_element('stickynotes_votes');
