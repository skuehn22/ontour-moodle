...
$sql = "SELECT * FROM mdl_ext_operators WHERE id = ".$booking->operators_id;
...
$anrede = "Liebe Lehrkraft";
ob_start();
include "motivation_template.php";
...
$sql = "SELECT * FROM mdl_booking_history3 WHERE user_id = $user_id && type = 'mail_mo' && state = 2";
