...
-->
    ...
    <p style="margin: 0 0 16px; color: #49AEDB; font-weight: 700; font-size: 18px;">'.$anrede.',</p>';


echo'
        <p style="margin: 0 0 16px; line-height: normal;">
            <span style="font-size: 12px; line-height: normal;"></span></p><p style="margin: 0 0 16px;"> Vielen Dank für die Teilnahme am Videoprojekt letzte Woche. In Ihrer App finden Sie den Abgabestand der einzelnen Gruppen:
        </p><p>Login für die App: <b>'.$app_code.'</b></p>';
...
echo'
    <p style="margin: 0 0 16px;">Sollten die Abgaben nicht vollständig sein, motivieren Sie gerne Ihre Schüler*innen diese nachzureichen. Umso mehr Abgaben, umso besser der Erinnerungsfilm, den wir produzieren können.</p>
    <p style="margin: 0 0 16px;">Denken Sie außerdem daran im Kundenbereich die Namen aller teilnehmen Schüler*innen und Lehrkräfte einzugeben und eventuell einen persönlichen Gruß an Ihre Klasse hinzuzufügen. Dies arbeiten wir in den Erinnerungsfilm ein.</p>
    <p style="margin: 0 0 16px;">Bitte reichen Sie und Ihre Schüler sämtliche Dateien in den nächsten 5 Tagen ein, damit wir Ihnen Ihren Erinnerungsfilm in ca. 4 Wochen liefern können.</p>
    <p style="margin: 0 0 16px;">Wenn Sie dazu Fragen oder Anmerkungen haben, kontaktieren Sie uns gern. Unser Ziel ist es Ihnen einen einmaligen und hochwertigen Erinnerungsfilm zur Verfügung zu stellen!</p>
    <br><br>';
