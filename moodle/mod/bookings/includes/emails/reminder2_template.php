...
-->
    ...
    echo'
        <p style="margin: 0 0 16px; line-height: normal;">
            <span style="font-size: 12px; line-height: normal;"></span></p><p style="margin: 0 0 16px;"> Bitte schalten Sie nun unbedingt das Videoprojekt Berlin frei, da sonst eine Durchführung nicht möglich ist.
        </p>';
