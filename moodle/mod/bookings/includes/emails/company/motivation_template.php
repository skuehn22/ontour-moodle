...
echo'
        <p style="margin: 0 0 16px; line-height: normal;">
            <span style="font-size: 12px; line-height: normal;"></span></p><p style="margin: 0 0 16px;"> bald ist es soweit, Ihre Klassenfahrt nach Berlin beginnt und Ihre Klasse führt in der Hauptstadt das Videoprojekt durch. Hier eine kleine Checkliste, was Sie <b>im Vorfeld</b> der Klassenfahrt für das Videoprojekt erledigt haben sollten: 
...
echo '
    <ol>
      <li>Haben Sie Sie mit Ihrer Klasse 3 bis 5 Gruppen gebildet?</li>
      <li>Hat mindestens ein*e Schüler*in pro Gruppe die App heruntergeladen und sich registriert? (besser Mehrere).  </li>
      <li>Haben auch Sie als Lehrkraft die App heruntergeladen, um am Videoprojekt teilnehmen zu können?</li>
      <li>Haben Sie sich mit Ihrer Klasse für einen oder mehrere Drehorte entschieden?  

             Falls nicht, holen Sie das in den kommenden Tagen nach. Nutzen Sie    dazu den     
...
echo '<p>Detaillierte Infos und Material finden Sie im Kundenbereich.  </p>
';
...
<table style="width: 100%; border-spacing: inherit;" width="100%" cellspacing="inherit">
    ...
    Wir wünschen Ihnen viel Spaß in Berlin, <br>
