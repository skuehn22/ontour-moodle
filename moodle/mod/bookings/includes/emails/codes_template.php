...
echo'<html><head>
<title>Videoprojekt Berlin // '.$b_id.'</title>
...
-->
    ...
    echo'
        <p style="margin: 0 0 16px; line-height: normal;">
            <span style="font-size: 12px; line-height: normal;"></span></p><p style="margin: 0 0 16px;">vielen Dank für Ihre Buchung. Wir freuen uns sehr, dass Sie am Videoprojekt Berlin teilnehmen. Bitte schalten Sie das Videoprojekt für Ihre Klasse spätestens 4 Wochen vor der Klassenfahrt mit dem Zugangscode weiter unten frei. 
        </p>';
    */

    echo'
        <p style="margin: 0 0 16px; line-height: normal;">
            <span style="font-size: 12px; line-height: normal;"></span></p><p style="margin: 0 0 16px;">Ihre Klassenfahrt beginnt am '.$arrival_mail.', eine Zeit voller Erlebnisse. Halten Sie die Eindrücke gemeinsam mit uns und Ihren Schüler*innen in einem einmaligen Erinnerungsfilm fest.
        </p>';

    echo '
    <p style="margin: 0 0 15px; font-weight: 700; font-size: 16px;">In Ihr Videoprojekt einloggen:</p>';
    echo $z_codes_string;
...
echo'
        <p style="margin: 0 0 16px; line-height: normal;">
           Hier finden Sie:</p>  <p style="margin: 0 0 16px; line-height: normal;">
           <ul>
               
                 <li>Einblick in die Stadtteile zur Vorbereitung der Stadterkundung </li>
                  <li>Alle Codes zum Aktivieren der onTour-App</li>
            </ul>
        </p>  <p style="margin: 0 0 16px; line-height: normal;">Wir von onTour wünschen Ihnen und Ihren Schüler*innen lebendige Erinnerungen!</p> <p style="margin: 0 0 16px; line-height: normal;">Bitte zögern Sie nicht uns zu kontaktieren. Wir sind wochentags zwischen 9:30-15:30 Uhr für Sie da.</p>';

    if($booking->operators_id == 1){
        echo 'Anbei finden Sie Ihre Rechnung mit einem Zahlungsziel bis 14 Tage vor Anreise nach Berlin.<br>
Sollten Sie das Videoprojekt schon in den kommenden Tagen durchführen, überweisen Sie die Rechnung bitte sofort. Falls Sie per Paypal gezahlt haben, ist der Rechnungsbetrag schon beglichen.
';
    }
...
if($booking->operators_id == 1){
        ...
        <table class="td" style="color: #696969; vertical-align: middle; width: 100%; font-family:  Helvetica, Roboto, Arial, sans-serif; border-radius: 10px; border: 2px solid #49AEDB; font-size: 11px;" width="100%" cellspacing="0" cellpadding="6">
            <thead>
                <tr>
                    ...
                    <th class="td" scope="col" style="color: #696969; vertical-align: middle; padding: 12px; border: 0; text-align: left;" align="left">Beschreibung</th>
                    ...
                    <th class="td" scope="col" style="color: #696969; vertical-align: middle; padding: 12px; border: 0; text-align: right;" align="right">Preis</th>
                </tr>
            </thead>';
    ...
    foreach ($data as $d){
        echo '<tbody>
				<tr class="order_item">
		            <td colspan="2" class="td" style="color: #696969; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: Helvetica, Roboto, Arial, sans-serif; word-wrap: break-word; border-right: 0px;" align="left">
                        Videoprojekt
                        <ul class="wc-item-meta" style="font-size: small; margin: 1em 0 0; padding: 0; list-style: none;">
                            <li style="margin: .5em 0 0; padding: 0;">
                            <strong class="wc-item-meta-label" style="font-size: 11px; float: left; margin-right: .25em; clear: both;">Anreisetag der Klassenfahrt:</strong> <p style="font-size: 11px; margin: 0;">'.$d['arr'].'</p>
                            </li>
                            <li style="margin: .5em 0 0; padding: 0;">
                            <strong class="wc-item-meta-label" style="font-size: 11px; float: left; margin-right: .25em; clear: both;">Abreisetag der Klassenfahrt:</strong> <p style="font-size: 11px; margin: 0;">'.$d['dep'].'</p>
                            </li>
                            <li style="margin: .5em 0 0; padding: 0;">
                            <strong class="wc-item-meta-label" style="font-size: 11px; float: left; margin-right: .25em; clear: both;">Anzahl der Schüler*innen:</strong> <p style="font-size: 11px; margin: 0;">'.$d['amount'].'</p>
                            </li>
                            <li style="margin: .5em 0 0; padding: 0;">
                            <strong class="wc-item-meta-label" style="font-size: 11px; float: left; margin-right: .25em; clear: both;">Durchschnittsalter der Schüler*innen:</strong> <p style="font-size: 11px; margin: 0;">'.$d['age'].'</p>
                            </li>
                        </ul>		
                    </td>

                    <td class="td" style="color: #696969; border: 1px solid #e5e5e5; padding: 12px; text-align: right; vertical-align: middle; font-family:  Helvetica, Roboto, Arial, sans-serif; border-right: 0px;" align="right">
                         ';

        if($booking->operators_id == 1){
            echo $data[$i]['item_price'].' €';
        }
