...
ob_start();
include "reminder2_template.php";
...
$sql = "SELECT * FROM mdl_booking_history3 WHERE user_id = $user_id && type = 'mail_er2' && state = 2";
...
if($mail_mo){
    ...
    $obj->sender = "";
    $obj->type = "mail_er2";
    $obj->subject = "Erinnerung 2 geschickt";
    $obj->state = 1;
